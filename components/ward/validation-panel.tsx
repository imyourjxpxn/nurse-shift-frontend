          ...
          {warnings.length === 0 ? (
            ...
            <ul className="space-y-2">
              {visibleWarnings.map((w, i) => (
                <li
                  key={i}
                  className="flex items-start gap-3 rounded-lg border border-amber-200 bg-amber-50/60 px-3 py-2.5"
                >
                  <span className="mt-0.5 flex size-5 shrink-0 items-center justify-center rounded-full bg-amber-400 text-[10px] font-bold text-amber-950">
                    {w.day}
                  </span>
